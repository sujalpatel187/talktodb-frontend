...
export const trainGlossary = (data) =>
  request("/train/glossary", { method: "POST", body: JSON.stringify(data) });

export const trainGlossaryBulk = (records) =>
  request("/train/glossary/bulk", {
    method: "POST",
    body: JSON.stringify({ records }),
  });
